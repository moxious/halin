...
/**
 * Neo4jCluster is a controller object that keeps track of state and permits diagnostic
 * reporting.
 * 
 ...
 */
export default class Neo4jCluster {
    constructor() {
        this.project = null;
        this.graph = null;
        this.drivers = {};
    ...
    checkForCluster(activeDb) {
        ...
        return session.run(queryLibrary.disclaim(`
            ...
            .then(results => {
                ...
                this.clusterMembers = results.records.map(rec => new ClusterNode(rec));
